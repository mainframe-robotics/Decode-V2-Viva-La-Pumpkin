...
@Autonomous(name = "Red9Ball", group = "Examples")
public class Red9Ball extends OpMode {
    ...
    private final Pose startPose = new Pose(120,121,Math.toRadians(40));
    private final Pose shoot1Pose = new Pose(55.98 - 2,87.435 - 2,Math.toRadians(90)).mirror();
    private final Pose intake1Pose = new Pose(30,83.4 - 2, Math.toRadians(180)).mirror();
    private final Pose intake1PoseControl = new Pose(71.5,73.4);
    private final Pose shoot2Pose = new Pose(55.98 - 2,87.435 - 2,Math.toRadians(-45)).mirror();
    private final Pose intake2Pose = new Pose(28.42,58.29 - 1.5,Math.toRadians(180)).mirror();
    private final Pose intake2PoseControl = new Pose(58,54 - 1.5).mirror();
    private final Pose shoot3Pose = new Pose(55.98 - 2,87.435 - 2,Math.toRadians(180 + 30)).mirror();
    private final Pose leavePose = new Pose(45.4,66.7,Math.toRadians(180)).mirror();
    ...
    scorePreload.setConstantInterpolation(startPose.getHeading()); */
        ...
        intakeSet1 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(0, intake1Pose.getHeading())
                .build();
        ...
        intakeSet2 = follower.pathBuilder()
                ...
                .setHeadingInterpolation(
                        HeadingInterpolator.piecewise(
                                new HeadingInterpolator.PiecewiseNode(0, 0.35, HeadingInterpolator.constant(Math.toRadians(-45))),
                                new HeadingInterpolator.PiecewiseNode(0.35, 1, HeadingInterpolator.constant(Math.toRadians(0)))
                        )
                )
                .build();
...
//                .setReversed()
                .setHeadingInterpolation(
                        HeadingInterpolator.linear(Math.toRadians(0), shoot3Pose.getHeading())
                )
                .build();
